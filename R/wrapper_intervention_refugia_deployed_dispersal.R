...
wrapper_intervention_refugia_deployed_dispersal = function(insecticide.population.suppression,
  ...
  intervention.after.selection = wrapper_intervention_site_after_selection_deployed(intervention.before.selection = intervention.before.selection,
