...
indirect_cross_selection = function(genetic.correlation,
  ...
  direct.selection  =  wrapper_intervention_site_after_selection_deployed(intervention.before.selection = intervention.before.selection,
