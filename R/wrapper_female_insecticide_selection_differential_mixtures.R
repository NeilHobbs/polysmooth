...
wrapper_female_insecticide_selection_differential_mixtures = function(intervention.before.selection,
  ...
  relative.female.contributions.after.selection =  calculate_female_density_after_selection(female.insecticide.exposure = female.insecticide.exposure,
                                                                                            ...
                                                                                            current.insecticide.efficacy = current.insecticide.efficacy)*survival.to.other.insecticide
