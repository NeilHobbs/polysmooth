...
wrapper_calculate_female_insecticide_fitness_selection_differential_mixtures = function(female.trait.mean,
  ...
  female.insecticide.selection.differential = wrapper_female_insecticide_selection_differential_mixtures(intervention.before.selection = female.trait.mean,
