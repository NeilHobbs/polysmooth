#'@title Calculate the relative population contribution to the population of female mosquitoes with a Polygenic Resistance Score after the insecticide encounter in the intervention site.
#'
...
calculate_female_density_after_selection = function(female.insecticide.exposure,
                                                    vector.length,
                                                    trait.mean,
                                                    standard.deviation,
  ...
  relative.female.contribution.after.selection = relative.female.contribution.before.selection * field.survivals * female.insecticide.exposure

  return(relative.female.contribution.after.selection)
}
