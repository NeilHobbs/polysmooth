multiple_gonotrophic_cycles_micromosaics_dispersal_not_deployed_sd_scaled = function(intervention.trait.mean.i,
  ...
  calc.fitness.cost.intervention.i = sd_changes_with_z(current.z = intervention.trait.mean.i,
                                                       z.sd.intercept = z.sd.intercept,
                                                       z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.i

  calc.fitness.cost.intervention.j = sd_changes_with_z(current.z = intervention.trait.mean.j,
                                                       z.sd.intercept = z.sd.intercept,
                                                       z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.j
  calc.fitness.cost.intervention.tracked = sd_changes_with_z(current.z = intervention.trait.mean.tracked,
                                                       z.sd.intercept = z.sd.intercept,
                                                       z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.tracked


  calc.fitness.cost.refugia.i = sd_changes_with_z(current.z = refugia.trait.mean.i,
                                                  z.sd.intercept = z.sd.intercept,
                                                  z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.i

  calc.fitness.cost.refugia.j = sd_changes_with_z(current.z = refugia.trait.mean.j,
                                                  z.sd.intercept = z.sd.intercept,
                                                  z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.j

  calc.fitness.cost.refugia.tracked = sd_changes_with_z(current.z = refugia.trait.mean.tracked,
                                                  z.sd.intercept = z.sd.intercept,
                                                  z.sd.coefficient = z.sd.coefficient) * female.fitness.cost.tracked
  ...
  intervention.normal.distribution.tracked = create_normal_distribution(vector.length = vector.length,
                                                                        ...
                                                                        standard.deviation = sd_changes_with_z(current.z = intervention.trait.mean.tracked,
                                                                                                               z.sd.intercept = z.sd.intercept,
                                                                                                               z.sd.coefficient = z.sd.coefficient))
  ...
  refugia.normal.distribution.tracked = create_normal_distribution(vector.length = vector.length,
                                                                   ...
                                                                   standard.deviation = sd_changes_with_z(current.z = refugia.trait.mean.tracked,
                                                                                                          z.sd.intercept = z.sd.intercept,
                                                                                                          z.sd.coefficient = z.sd.coefficient))
  ...
  if(coverage < 1){
        ...
        int.in.int.differential.i[[1]]  = exposure.scaling.factor * ((sum(int.staying.int.i[[1]] *intervention.normal.distribution.i) / int.number.in.int.i[[1]] ) - intervention.trait.mean.i) - calc.fitness.cost.intervention.i
        int.in.ref.differential.i[[1]]  = exposure.scaling.factor * ((sum(int.joining.ref.i[[1]] *intervention.normal.distribution.i) / int.number.in.ref.i[[1]] ) - intervention.trait.mean.i) - calc.fitness.cost.intervention.i

        ref.in.ref.differential.i[[1]]  = exposure.scaling.factor * ((sum(ref.staying.ref.i[[1]] *refugia.normal.distribution.i) / ref.number.in.ref.i[[1]] ) - refugia.trait.mean.i) - calc.fitness.cost.refugia.i
        ref.in.int.differential.i[[1]]  = exposure.scaling.factor * ((sum(ref.joining.int.i[[1]] *refugia.normal.distribution.i) / ref.number.in.int.i[[1]] ) - refugia.trait.mean.i) - calc.fitness.cost.refugia.i
        ...
        int.in.int.differential.j[[1]]  = exposure.scaling.factor * ((sum(int.staying.int.j[[1]] *intervention.normal.distribution.j) / int.number.in.int.j[[1]] ) - intervention.trait.mean.j) - calc.fitness.cost.intervention.j
        int.in.ref.differential.j[[1]]  = exposure.scaling.factor * ((sum(int.joining.ref.j[[1]] *intervention.normal.distribution.j) / int.number.in.ref.j[[1]] ) - intervention.trait.mean.j) - calc.fitness.cost.intervention.j

        ref.in.ref.differential.j[[1]]  = exposure.scaling.factor * ((sum(ref.staying.ref.j[[1]] *refugia.normal.distribution.j) / ref.number.in.ref.j[[1]] ) - refugia.trait.mean.j) - calc.fitness.cost.refugia.j
        ref.in.int.differential.j[[1]]  = exposure.scaling.factor * ((sum(ref.joining.int.j[[1]] *refugia.normal.distribution.j) / ref.number.in.int.j[[1]] ) - refugia.trait.mean.j) - calc.fitness.cost.refugia.j
        ...
        int.in.int.differential.tracked[[1]]  = exposure.scaling.factor * ((sum(int.staying.int.tracked[[1]] *intervention.normal.distribution.tracked) / int.number.in.int.tracked[[1]] ) - intervention.trait.mean.tracked) - calc.fitness.cost.intervention.tracked
        int.in.ref.differential.tracked[[1]]  = exposure.scaling.factor * ((sum(int.joining.ref.tracked[[1]] *intervention.normal.distribution.tracked) / int.number.in.ref.tracked[[1]] ) - intervention.trait.mean.tracked) - calc.fitness.cost.intervention.tracked

        ref.in.ref.differential.tracked[[1]]  = exposure.scaling.factor * ((sum(ref.staying.ref.tracked[[1]] *refugia.normal.distribution.tracked) / ref.number.in.ref.tracked[[1]] ) - refugia.trait.mean.tracked) - calc.fitness.cost.refugia.tracked
        ref.in.int.differential.tracked[[1]]  = exposure.scaling.factor * ((sum(ref.joining.int.tracked[[1]] *refugia.normal.distribution.tracked) / ref.number.in.int.tracked[[1]] ) - refugia.trait.mean.tracked) - calc.fitness.cost.refugia.tracked
     ...
     for(gonotrophic in 2:n.cycles){
        ...
        ref.staying.ref.i[[gonotrophic]] = ((ref.staying.ref.i[[gonotrophic-1]] * (1-dispersal.rate)) +
          ...
          (ref.joining.int.i[[gonotrophic-1]] * female.exposure * dispersal.rate * mean.survival.ref.j * coverage.j))*between.gonotrophic.survival
        ...
        int.in.int.differential.i[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.staying.int.i[[gonotrophic]] *intervention.normal.distribution.i) / int.number.in.int.i[[gonotrophic]] ) - intervention.trait.mean.i) - calc.fitness.cost.intervention.i
        int.in.ref.differential.i[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.joining.ref.i[[gonotrophic]] *intervention.normal.distribution.i) / int.number.in.ref.i[[gonotrophic]] ) - intervention.trait.mean.i) - calc.fitness.cost.intervention.i

        ref.in.ref.differential.i[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.staying.ref.i[[gonotrophic]] *refugia.normal.distribution.i) / ref.number.in.ref.i[[gonotrophic]] ) - refugia.trait.mean.i) - calc.fitness.cost.refugia.i
        ref.in.int.differential.i[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.joining.int.i[[gonotrophic]] *refugia.normal.distribution.i) / ref.number.in.int.i[[gonotrophic]] ) - refugia.trait.mean.i) - calc.fitness.cost.refugia.i
        ...
        ref.staying.ref.j[[gonotrophic]] = ((ref.staying.ref.j[[gonotrophic-1]] *(1-dispersal.rate)) +
          ...
          (ref.joining.int.j[[gonotrophic-1]] * female.exposure * dispersal.rate * mean.survival.ref.i * coverage.j))*between.gonotrophic.survival
        ...
        int.in.int.differential.j[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.staying.int.j[[gonotrophic]] *intervention.normal.distribution.j) / int.number.in.int.j[[gonotrophic]] ) - intervention.trait.mean.j) - calc.fitness.cost.intervention.j
        int.in.ref.differential.j[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.joining.ref.j[[gonotrophic]] *intervention.normal.distribution.j) / int.number.in.ref.j[[gonotrophic]] ) - intervention.trait.mean.j) - calc.fitness.cost.intervention.j

        ref.in.ref.differential.j[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.staying.ref.j[[gonotrophic]] *refugia.normal.distribution.j) / ref.number.in.ref.j[[gonotrophic]] ) - refugia.trait.mean.j) - calc.fitness.cost.refugia.j
        ref.in.int.differential.j[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.joining.int.j[[gonotrophic]] *refugia.normal.distribution.j) / ref.number.in.int.j[[gonotrophic]] ) - refugia.trait.mean.j) - calc.fitness.cost.refugia.j
        ...
        ref.staying.ref.tracked[[gonotrophic]] = ((ref.staying.ref.tracked[[gonotrophic-1]] *(1-dispersal.rate)) +
          ...
          (ref.joining.int.tracked[[gonotrophic-1]] * female.exposure * dispersal.rate * mean.survival.ref.i * coverage.i))*between.gonotrophic.survival
        ...
        int.in.int.differential.tracked[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.staying.int.tracked[[gonotrophic]] *intervention.normal.distribution.tracked) / int.number.in.int.tracked[[gonotrophic]] ) - intervention.trait.mean.tracked) - calc.fitness.cost.intervention.tracked
        int.in.ref.differential.tracked[[gonotrophic]]  = exposure.scaling.factor * ((sum(int.joining.ref.tracked[[gonotrophic]] *intervention.normal.distribution.tracked) / int.number.in.ref.tracked[[gonotrophic]] ) - intervention.trait.mean.tracked) - calc.fitness.cost.intervention.tracked

        ref.in.ref.differential.tracked[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.staying.ref.tracked[[gonotrophic]] *refugia.normal.distribution.tracked) / ref.number.in.ref.tracked[[gonotrophic]] ) - refugia.trait.mean.tracked) - calc.fitness.cost.refugia.tracked
        ref.in.int.differential.tracked[[gonotrophic]]  = exposure.scaling.factor * ((sum(ref.joining.int.tracked[[gonotrophic]] *refugia.normal.distribution.tracked) / ref.number.in.int.tracked[[gonotrophic]] ) - refugia.trait.mean.tracked) - calc.fitness.cost.refugia.tracked
  ...
  if(coverage == 1 | dispersal.rate == 0){
      ...
      for(gonotrophic in 2:n.cycles){
        ...
        int.staying.int.i[[gonotrophic]]  = ((int.staying.int.i[[gonotrophic-1]] * (1-female.exposure) ) +
          ...
          (int.staying.int.i[[gonotrophic-1]] * female.exposure * mean.survival.int.j * coverage.j))*between.gonotrophic.survival
        ...
        int.staying.int.j[[gonotrophic]]  = ((int.staying.int.j[[gonotrophic-1]] * (1-female.exposure)) +
          ...
          (int.staying.int.j[[gonotrophic-1]] * female.exposure * mean.survival.int.i * coverage.i))*between.gonotrophic.survival
        ...
        int.staying.int.tracked[[gonotrophic]]  = ((int.staying.int.tracked[[gonotrophic-1]] * (1-female.exposure)) +
          ...
          (int.staying.int.tracked[[gonotrophic-1]] * female.exposure * mean.survival.int.i * coverage.i))*between.gonotrophic.survival
