irm_strategy_micromosaics_full_rotation = function(number.of.insecticides,
 ...
 #Temporarily make the to.replace insecticides unavailable; this means it cannot be a new candidate,
  ...
  #remove candidate.1 as being possible for candidate.2
  available.to.deploy.temp.1 = available.to.deploy.temp[!available.to.deploy.temp %in% c(candidate.insecticide.1)]


  #find second candidate.insecticide:::
  candidate.insecticide.2 = choose_the_next_insecticide(previous.insecticide = deployed.insecticide.j,
                                                        available.insecticides = available.to.deploy.temp.1,
                                                        number.of.insecticides = number.of.insecticides)
