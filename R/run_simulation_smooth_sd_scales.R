...
# #It is important to note that this model version currently works for mixtures only when there are 2 insecticides. Running as singles, any number of
# #insecticides can be included.
#
#
# #Superceded by run_sim_advanced methodology
# run_simulation_smooth_sd_scales = function(number.of.insecticides = 2,
...
#
#             tracked.resistance = wrapper_intervention_refugia_deployed_dispersal(insecticide.population.suppression = wrapper_calculate_population_suppresion(current.insecticide.efficacy = insecticide.efficacy.vector[generation],
...
#                                                                                  female.insecticide.exposure = female.insecticide.exposure * sd_changes_with_z(current.z = sim.array['intervention', insecticide, generation-1],
#                                                                                                                                                                z.sd.intercept = z.sd.intercept,
#                                                                                                                                                                z.sd.coefficient = z.sd.coefficient),
#                                                                                  male.insecticide.exposure = male.insecticide.exposure * sd_changes_with_z(current.z = sim.array['intervention', insecticide, generation-1],
#                                                                                                                                                            z.sd.intercept = z.sd.intercept,
#                                                                                                                                                            z.sd.coefficient = z.sd.coefficient),
#                                                                                  standard.deviation = sd_changes_with_z(current.z = sim.array['intervention', insecticide, generation-1],
#                                                                                                                         z.sd.intercept = z.sd.intercept,
#                                                                                                                         z.sd.coefficient = z.sd.coefficient),
#                                                                                  vector.length = vector.length,
#                                                                                  maximum.bioassay.survival.proportion = maximum.bioassay.survival.proportion,
...
#           if(insecticide != deployed.insecticide[generation]){
#
#             tracked.resistance = wrapper_intervention_refugia_not_deployed_dispersal(insecticide.population.suppression = wrapper_calculate_population_suppresion(current.insecticide.efficacy = insecticide.efficacy.vector[generation],
#                                                                                                                                                                   currently.deployed.insecticide = deployed.insecticide[generation],
#                                                                                                                                                                   vector.length = vector.length,
#                                                                                                                                                                   current.generation = generation,
#                                                                                                                                                                   standard.deviation = standard.deviation,
...
#                                                                                      standard.deviation = sd_changes_with_z(current.z = sim.array['intervention', deployed.insecticide[generation], generation-1],
#                                                                                                                                        z.sd.intercept = z.sd.intercept,
#                                                                                                                                        z.sd.coefficient = z.sd.coefficient),
#                                                                                      vector.length = vector.length,
#                                                                                      maximum.bioassay.survival.proportion = maximum.bioassay.survival.proportion,
...
#             tracked.resistance =  wrapper_intervention_refugia_deployed_dispersal_mixtures_sd_scales(insecticide.population.suppression = wrapper_calculate_population_suppresion_mixtures(vector.length = vector.length,
#                                                                                                                                                                                  current.generation = generation,
#                                                                                                                                                                                  standard.deviation = standard.deviation,
#                                                                                                                                                                                  female.insecticide.exposure = female.insecticide.exposure,
#                                                                                                                                                                                  maximum.bioassay.survival.proportion = maximum.bioassay.survival.proportion,
