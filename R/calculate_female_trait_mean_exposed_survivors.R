...
calculate_female_trait_mean_exposed_survivors = function(vector.length,
                                                         trait.mean,
                                                         standard.deviation,
  ...
  relative.contribution.after.selection =  calculate_female_density_after_selection(female.insecticide.exposure = female.insecticide.exposure,
  ...
  female.trait.mean.exposed.survivors = sum(normal.distribution*relative.contribution.after.selection.scaled)/(sum(relative.contribution.after.selection.scaled))
