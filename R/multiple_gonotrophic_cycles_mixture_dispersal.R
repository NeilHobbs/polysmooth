multiple_gonotrophic_cycles_mixture_dispersal = function(intervention.trait.mean.i,
  ...
  if(coverage < 1){
        ...
        int.staying.int.i[[1]]  = (initial.intervention.densities.i * female.exposure * survival.probability.int.i * mean.survival.int.j * coverage * (1-dispersal.rate)) + (initial.intervention.densities.i * (1-female.exposure) * coverage * (1-dispersal.rate))
        int.joining.ref.i[[1]]  = (initial.intervention.densities.i * female.exposure * survival.probability.int.i * mean.survival.int.j * coverage * dispersal.rate) + (initial.intervention.densities.i * (1-female.exposure) * coverage * dispersal.rate)
        ...
        int.staying.int.j[[1]]  = (initial.intervention.densities.j * female.exposure * survival.probability.int.j * mean.survival.int.i * coverage * (1-dispersal.rate)) + (initial.intervention.densities.j * (1-female.exposure) * coverage * (1-dispersal.rate))
        int.joining.ref.j[[1]]  = (initial.intervention.densities.j * female.exposure * survival.probability.int.j * mean.survival.int.i * coverage * dispersal.rate) + (initial.intervention.densities.j * (1-female.exposure) * coverage * dispersal.rate)
      ...
      for(gonotrophic in 2:n.cycles){
        ...
        ref.staying.ref.i[[gonotrophic]] = ((ref.staying.ref.i[[gonotrophic-1]] *(1-dispersal.rate)) +
          ...
          (ref.joining.int.i[[gonotrophic-1]] * female.exposure * dispersal.rate * mean.survival.ref.j * survival.probability.ref.i))*between.gonotrophic.survival
        ...
        ref.staying.ref.j[[gonotrophic]] = ((ref.staying.ref.j[[gonotrophic-1]] *(1-dispersal.rate)) +
          ...
          (ref.joining.int.j[[gonotrophic-1]] * female.exposure * dispersal.rate * mean.survival.ref.i * survival.probability.ref.j))*between.gonotrophic.survival
  ...
  if(coverage == 1 | dispersal.rate == 0){
        ...
        int.staying.int.i[[1]]  = (initial.intervention.densities.i * female.exposure * survival.probability.int.i * mean.survival.int.j * coverage) + (initial.intervention.densities.i * (1-female.exposure) * coverage)
        ...
        int.staying.int.j[[1]]  = (initial.intervention.densities.j * female.exposure * survival.probability.int.j * mean.survival.int.i * coverage) + (initial.intervention.densities.j * (1-female.exposure) * coverage)
      ...
      for(gonotrophic in 2:n.cycles){
        ...
        int.staying.int.i[[gonotrophic]]  = ((int.staying.int.i[[gonotrophic-1]] * (1-female.exposure)) +
          (int.staying.int.i[[gonotrophic-1]] * female.exposure  * mean.survival.int.j * survival.probability.int.i))*between.gonotrophic.survival
        ...
        int.staying.int.j[[gonotrophic]]  = ((int.staying.int.j[[gonotrophic-1]] * (1-female.exposure))+
          (int.staying.int.j[[gonotrophic-1]] * female.exposure  * mean.survival.int.i * survival.probability.int.j))*between.gonotrophic.survival
