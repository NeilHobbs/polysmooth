...
wrapper_breeders_equation_male_female_insecticide_fitness_mixtures = function(trait.mean,
                                                                     female.fitness.cost,
                                                                     male.fitness.cost,
  ...
  female.insecticide.fitness.selection.differential = wrapper_calculate_female_insecticide_fitness_selection_differential_mixtures(female.trait.mean = trait.mean,
  ...
  male.insecticide.fitness.selection.differential =  wrapper_calculate_male_insecticide_fitness_selection_differential_mixtures(male.trait.mean = trait.mean,
                                                                                                                       female.insecticide.exposure = female.insecticide.exposure,
