...
multiple_gonotrophic_cycles_mixture_dispersal_not_deployed_sd_scaled = function(intervention.trait.mean.i,
  ...
  if(coverage < 1){
        ...
        int.staying.int.i[[1]]  = (initial.intervention.densities.i * female.exposure * survival.probability.int.i *  coverage * (1-dispersal.rate)) +
        ...
        int.joining.ref.i[[1]]  = (initial.intervention.densities.i * female.exposure * mean.survival.int.j * survival.probability.int.i * coverage * dispersal.rate) + #both ij
        ...
        int.staying.int.j[[1]]  = (initial.intervention.densities.j * female.exposure *  mean.survival.int.i * survival.probability.int.j * coverage * (1-dispersal.rate)) + #both ij
          (initial.intervention.densities.j * (1-female.exposure) * coverage * (1-dispersal.rate))


        int.joining.ref.j[[1]]  = (initial.intervention.densities.j * female.exposure * mean.survival.int.i * survival.probability.int.j * coverage * dispersal.rate) + #both ij
        ...
        int.staying.int.tracked[[1]]  = ((initial.intervention.densities.tracked * (1-female.exposure) * coverage * (1-dispersal.rate)))+
        ...
        int.joining.ref.tracked[[1]]  = ((initial.intervention.densities.tracked * female.exposure * mean.survival.int.j * mean.survival.int.i * coverage * dispersal.rate)) + #both ij
  ...
  if(coverage == 1 | dispersal.rate == 0){
        ...
        int.staying.int.i[[1]]  =(initial.intervention.densities.i * female.exposure * mean.survival.int.j * survival.probability.int.i * coverage) + #both ij
        ...
        int.staying.int.j[[1]]  = (initial.intervention.densities.j * female.exposure * mean.survival.int.i * survival.probability.int.j * coverage) + #both ij
        ...
        ##And the tracked insecticide:::::
        int.staying.int.tracked[[1]]  = (initial.intervention.densities.tracked * female.exposure * mean.survival.int.i * mean.survival.int.j * coverage) + #both ij
