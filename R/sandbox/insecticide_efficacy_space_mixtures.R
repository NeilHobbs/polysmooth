...
for(i in 1:2500){
  pyrethroid.response[i] = wrapper_intervention_site_after_selection_deployed_mixtures_sd_scaled(intervention.before.selection = initial.resistance.pyrethroid[i],
  ...
  novel.response[i] = wrapper_intervention_site_after_selection_deployed_mixtures_sd_scaled(intervention.before.selection = initial.resistance.novel[i],
                                                                                            female.fitness.cost = 0,
                                                                                            male.fitness.cost = 0,
                                                                                            female.insecticide.exposure = 0.7,
                                                                                            male.insecticide.exposure =0.7,
