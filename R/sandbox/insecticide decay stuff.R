...
compare.decay.df = dplyr::inner_join(mixture.decay.df, solo.decay.df)
...
ggplot(compare.decay.df, aes(x=change.duration/10,
                             fill = dosing))+
...
solo.decay.scaled = c()
for(i in 1:9){
  A = get_simulation_dataframe(simulation.array = run_simulation_smooth_test(number.of.insecticides = 1,
                                                                                 exposure.scaling.factor = 10,
                                                                                 female.fitness.cost = 0,
                                                                                 male.fitness.cost = 0,
                                                                                 female.insecticide.exposure = 0.8,
...
for(i in 1:1296){
  A = get_simulation_dataframe_mixtures(simulation.array = run_simulation_smooth_test(number.of.insecticides = 2,
                                                                                          exposure.scaling.factor = 10,
                                                                                          female.fitness.cost = 0,
                                                                                          male.fitness.cost = 0,
                                                                                          female.insecticide.exposure = 0.8,
...
compare.decay.scaled.df = dplyr::inner_join(mixture.decay.scaled.df, solo.decay.scaled.df)
