multiple_gonotrophic_cycles_with_dispersal_v2 = function(coverage = 0.8,
  ...
  for(gonotrophic in 1:n.cycles){
    ...
    if(gonotrophic == 1){
      ...
      #Calculate the selection differentials::
        intervention.selection.differential.a = new.intervention.mean.a - intervention.trait.mean

        refugia.selection.differential.b = new.refugia.mean.b - refugia.trait.mean

      #calculate the responses::
        response.intervention.a = (exposure.scaling.factor * heritability * ((intervention.selection.differential.a + male.selection.differential.intervention) / 2))
        response.refugia.b = (exposure.scaling.factor * heritability * ((refugia.selection.differential.b + male.selection.differential.refugia)/2))
    ...
    if(gonotrophic != 1){
      ...
      #Calculate the selection differentials::
      intervention.selection.differential.a = new.intervention.mean.a - intervention.trait.mean
      intervention.selection.differential.b = new.intervention.mean.b - refugia.trait.mean

      refugia.selection.differential.a = new.intervention.mean.a - intervention.trait.mean
      refugia.selection.differential.b = new.refugia.mean.b - refugia.trait.mean

      #calculate the responses::
      response.intervention.a = (exposure.scaling.factor * heritability * ((intervention.selection.differential.a + male.selection.differential.intervention) / 2))
      response.intervention.b = (exposure.scaling.factor * heritability * ((intervention.selection.differential.b + male.selection.differential.refugia) / 2))

      response.refugia.a = (exposure.scaling.factor * heritability * ((refugia.selection.differential.a + male.selection.differential.intervention)/2))
      response.refugia.b = (exposure.scaling.factor * heritability * ((refugia.selection.differential.b + male.selection.differential.refugia)/2))
