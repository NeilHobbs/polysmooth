retry_multi_g_mix_dispersal = function(intervention.trait.mean.i,
  ...
  av.int.in.ref.response.j = mean(unlist(int.response.in.ref.j) * (unlist(int.number.in.ref.i)/N.int.in.ref.j))
