...
wrapper_intervention_refugia_deployed_dispersal_mixtures_sd_scales = function(insecticide.population.suppression,
  ...
  intervention.after.selection = wrapper_intervention_site_after_selection_deployed_mixtures(intervention.before.selection = intervention.before.selection,
                                                                                             female.fitness.cost = (female.fitness.cost*standard.deviation),
                                                                                             male.fitness.cost = (male.fitness.cost*standard.deviation),
