...
convert_output_to_dataframe_combinations = function(simulation.results,
                                                    maximum.generations,
  ...
  sim.duration = length(simulation.results[[4]])
  ...
  for(insecticide in 1:number.of.insecticides){
    ...
    if(sim.duration >= maximum.generations){
      ...
      llin.insecticide.deployed = rep(head(simulation.results[[5]], n = maximum.generations), 2)
      irs.insecticide.deployed = rep(head(simulation.results[[4]], n = maximum.generations), 2)
      llin.insecticide.efficacy = rep(head(simulation.results[[2]], n = maximum.generations), 2)
      irs.insecticide.efficacy = rep(head(simulation.results[[3]], n = maximum.generations), 2)
      ...
      llin.insecticide.deployed = rep(head(simulation.results[[5]], n = (sim.duration-1)), 2)
      irs.insecticide.deployed = rep(head(simulation.results[[4]], n = (sim.duration-1)), 2)
      llin.insecticide.efficacy = rep(head(simulation.results[[2]], n = (sim.duration-1)), 2)
      irs.insecticide.efficacy = rep(head(simulation.results[[3]], n = (sim.duration-1)), 2)
