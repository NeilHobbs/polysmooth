...
#
#
# run_simulation_micromosaic_mixtures_smooth = function(number.of.insecticides,
#                                                       maximum.generations,
...
#
#     male.selection.differentials = male_selection_differential_mixtures_smooth_micro_mosaics(trait.mean.1 = sim.array["intervention", 1, generation-1],
...
#                                                                                              insecticide.coverage = intervention.coverage,
...
#
#     tracked.response = perform_multiple_selection_mixture_smooth(max.cycles = max.cycles,
...
#                                                                  vector.length = vector.length,
#                                                                  female.exposure = female.insecticide.exposure,
#                                                                  male.selection.diff.1 = male.selection.differentials[[1]],
#                                                                  male.selection.diff.2 = male.selection.differentials[[2]],
#                                                                  current.insecticide.efficacy.1 = insecticide.efficacy.vector.1[generation],
#                                                                  current.insecticide.efficacy.2 = insecticide.efficacy.vector.2[generation],
#                                                                  regression.coefficient = regression.coefficient,
#                                                                  regression.intercept = regression.intercept,
#                                                                  heritability.1 = insecticide.parameters.df$heritability[1],
#                                                                  heritability.2 = insecticide.parameters.df$heritability[2],
