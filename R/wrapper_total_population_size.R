...
total.population.size = get_total_population_size(relative.contributions.before.selection = relative.contributions.before.selection)

return(total.population.size)
}

# wrapper_total_population_size(standard.deviation = 5,
#                               vector.length = 10)
