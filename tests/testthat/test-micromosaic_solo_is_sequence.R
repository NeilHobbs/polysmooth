...
#
# micromosaic.df.fixed  = run_simulation_advanced(irm.deployment.strategy = "micromosaics", #singles, mixtures, micromosaics, combinations
#                                              irm.switch.strategy = "sequence", #"rotation", "sequence", "insecticide.1"
#                                              number.of.insecticides = 2,
#                                              sd.scaled = FALSE, ##TRUE or FALSE
#                                              exposure.scaling.factor = 10,
...
#                                               max.cross.selection = 0)
#
# micromosaic.df.scaled  = run_simulation_advanced(irm.deployment.strategy = "micromosaics", #singles, mixtures, micromosaics, combinations
#                                               irm.switch.strategy = "sequence", #"rotation", "sequence", "insecticide.1"
#                                               number.of.insecticides = 2,
#                                               sd.scaled = TRUE, ##TRUE or FALSE
#                                               exposure.scaling.factor = 10,
...
#
#
# test_that("sequence and 100% micro identical fixed SD", {
#   expect_equal(micromosaic.df.fixed, sequence.df.fixed)
# })
#
# test_that("sequence and 100% micro identical scaled SD", {
#   expect_equal(micromosaic.df.scaled, sequence.df.scaled)
# })
