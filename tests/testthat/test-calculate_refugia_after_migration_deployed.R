test_that("cannot fall below zero", {
  expect_equal(calculate_refugia_after_migration_deployed(intervention.after.selection = -100,
...
test_that("there is complete exchange", {
  expect_equal(calculate_refugia_after_migration_deployed(intervention.after.selection = 500,
