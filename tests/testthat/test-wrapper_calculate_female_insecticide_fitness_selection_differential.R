test_that("no change when fitness and insecticide is zero", {
  expect_equal(wrapper_calculate_female_insecticide_fitness_selection_differential(female.trait.mean = 10,
...
test_that("exposure scaling factor multiplies correctly", {
  expect_equal(wrapper_calculate_female_insecticide_fitness_selection_differential(female.trait.mean = 10,
                                                                                   ...
                                                                                   exposure.scaling.factor = 10,
                                                                                   female.fitness.cost = 0), wrapper_calculate_female_insecticide_fitness_selection_differential(female.trait.mean = 10,
                                                                                                                                                                                 female.insecticide.exposure = 1,
                                                                                                                                                                                 standard.deviation = 10,
                                                                                                                                                                                 vector.length = 1000,
                                                                                                                                                                                 maximum.bioassay.survival.proportion = 1,
