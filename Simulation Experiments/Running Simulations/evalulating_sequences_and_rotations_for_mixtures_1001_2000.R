...
# df.1001_2000 = do.call(rbind, lifespans.list)
# write.csv(df.1001_2000, "seqrot_for_mixtures.1001_2000.csv")


df.5001_6000 = do.call(rbind, lifespans.list)
write.csv(df.5001_6000, "seqrot_for_mixtures.5001_6000.csv")
