#Micromosaics simulations : mixtures (FD_FD) comparator : with decay
#This adds in insecticide decay into the strategies just for completeness.
...
temp.df$strategy = "mixtures (FD_FD)"

write.csv(temp.df, "mm_simulations_mixtures_FDFD_comparator_decay.csv")
