...
# # print("Combi 3")
  ...
  #run the simulations
#   mixtures.half[[i]] = subset(run_simulation_advanced(irm.deployment.strategy = "mixtures", #singles, mixtures, micromosaics, combinations
...
mix.half = do.call(rbind, mixtures.half)
