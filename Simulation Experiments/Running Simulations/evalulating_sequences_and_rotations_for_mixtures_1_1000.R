...
# df.1_1000 = do.call(rbind, lifespans.list)
# write.csv(df.1_1000, "seqrot_for_mixtures.1_1000.csv")


df.4001_5000 = do.call(rbind, lifespans.list)
write.csv(df.4001_5000, "seqrot_for_mixtures.4001_5000.csv")
