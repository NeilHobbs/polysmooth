#Micromosaics simulations : mixtures (FD_FD) comparator
...
for(i in 33179:35000){
  A = subset(convert_output_to_dataframe_mixtures(wrapper_run_simulation_mixtures_sd_scaled(insecticide.parameters.df = create_insecticide_parameters_dataframe_advanced(number.of.insecticides = 2,
...
write.csv(temp.df, "mm_simulations_mixtures_FDFD_comparator_high_resistance.csv")
