...
df$llin.change = (peak.llin - solo.peak.llin)*100
df$irs.change = (peak.irs - solo.peak.irs)*100
df$total.change = ((peak.llin + peak.irs) - (solo.peak.llin + solo.peak.llin))*100
...
range(df$llin.change)
range(df$irs.change)
range(df$total.change)


g.1.llin = ggplot(subset(df, gonotrophic.cycles == 1), aes(x=encounter.irs,
               y=encounter.llin,
               fill = llin.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
                       values = scales::rescale(c(-20,0,10)),
                       guide = "colorbar", limits=c(-20,10))+
...
g.1.irs = ggplot(subset(df, gonotrophic.cycles == 1), aes(x=encounter.irs,
                                                           y=encounter.llin,
                                                           fill = irs.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.1.total = ggplot(subset(df, gonotrophic.cycles == 1), aes(x=encounter.irs,
                                                          y=encounter.llin,
                                                          fill = total.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.3.llin = ggplot(subset(df, gonotrophic.cycles == 3), aes(x=encounter.irs,
                                                           y=encounter.llin,
                                                           fill = llin.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.3.irs = ggplot(subset(df, gonotrophic.cycles == 3), aes(x=encounter.irs,
                                                          y=encounter.llin,
                                                          fill = irs.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.3.total = ggplot(subset(df, gonotrophic.cycles == 3), aes(x=encounter.irs,
                                                            y=encounter.llin,
                                                            fill = total.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.5.llin = ggplot(subset(df, gonotrophic.cycles == 5), aes(x=encounter.irs,
                                                           y=encounter.llin,
                                                           fill = llin.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.5.irs = ggplot(subset(df, gonotrophic.cycles == 5), aes(x=encounter.irs,
                                                          y=encounter.llin,
                                                          fill = irs.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
g.5.total = ggplot(subset(df, gonotrophic.cycles == 5), aes(x=encounter.irs,
                                                            y=encounter.llin,
                                                            fill = total.change))+
  geom_tile(colour = "black")+
  scale_fill_gradientn(colours = c("darkblue","white","darkred"),
...
GGGGGG
"
g.1.llin + g.1.irs + g.1.total+
g.5.llin + g.5.irs + g.5.total+figure.legend+ plot_layout(design = the.layout)
