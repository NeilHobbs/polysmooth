...
for(i in 2056:35000){
  A = subset(convert_output_to_dataframe_singles(wrapper_run_simulation_singles_sd_scaled(insecticide.parameters.df = create_insecticide_parameters_dataframe_advanced(number.of.insecticides = 2,
...
temp.df$strategy = "rotation"

write.csv(temp.df, "mm_simulations_rotation_comparator_high_resistance.csv")
