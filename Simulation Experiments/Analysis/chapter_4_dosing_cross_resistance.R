...
mixtures.df = read.csv(".//part.3.mixture.cross.resistance.polysmooth.csv")
solo.df = read.csv(".//part.3.solo.cross.resistance.polysmooth.csv")
rotation.df = read.csv(".//part.3.rotation.cross.resistance.polysmooth.csv")
...
plot.i + plot.j + plot.ij + plot_annotation(title = "polysmooth")
...
A+B+C + plot_annotation(title = "polysmooth")
