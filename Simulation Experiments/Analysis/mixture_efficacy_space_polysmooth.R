...
response.i = c()
response.j = c()
for(i in 1:length(resistance.i)){

response.i[i] = wrapper_intervention_site_after_selection_deployed_mixtures_sd_scaled(intervention.before.selection = resistance.i[i],
                                                                                              female.fitness.cost = 0,
                                                                                              male.fitness.cost = 0,
                                                                                              female.insecticide.exposure = female.encounter[i],
                                                                                              ...
                                                                                              regression.coefficient = 0.48,
                                                                                              regression.intercept = 0.15,
                                                                                              current.insecticide.efficacy = efficacy.i[i],
                                                                                              exposure.scaling.factor = 10,
                                                                                              heritability = 0.2,
                                                                                              survival.to.other.insecticide = survival.j[i])

response.j[i] = wrapper_intervention_site_after_selection_deployed_mixtures_sd_scaled(intervention.before.selection = resistance.j[i],
                                                                                              female.fitness.cost = 0,
                                                                                              male.fitness.cost = 0,
                                                                                              female.insecticide.exposure = female.encounter[i],
                                                                                              male.insecticide.exposure = 0.5,
                                                                                              ...
                                                                                              regression.coefficient = 0.48,
                                                                                              regression.intercept = 0.15,
                                                                                              current.insecticide.efficacy = efficacy.j[i],
                                                                                              exposure.scaling.factor = 10,
                                                                                              heritability = 0.2,
                                                                                              survival.to.other.insecticide = survival.i[i])
...
plot_mixure_efficacy_space = function(X,
  ...
  final.plot = plot.i + plot.j + plot.ij + plot_annotation(title = paste0("polysmooth:", encounter.description))
